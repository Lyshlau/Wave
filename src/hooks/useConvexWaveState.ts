...
export function useConvexWaveState() {
  ...
  const convexProfile = useQuery(api.userState.getProfile, { deviceId });
  const convexEntries = useQuery(api.userState.getDailyEntries, { deviceId });
